...
export class EventApiService {
  ...
  getEvents(period: EventPeriod = 'all', page = 0, size = 10): Observable<PagedEvents> {
  ...
  toggleInterest(eventId: number): Observable<ToggleInterestResponse> {
    return this._http.post<ToggleInterestResponse>(`${this._BASE_URL}/event/${eventId}/interest`, {});
  }
}
